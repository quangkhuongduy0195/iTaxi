...
import 'package:Taxi/src/resources/widgets/text_field_border.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void signUpClicked(BuildContext context) async {
  ...
  void goBack(BuildContext context, LoginInfoModel loginInfoModel){
    ...
    NavigationHelper.pop(context, loginInfoModel);
  }
}